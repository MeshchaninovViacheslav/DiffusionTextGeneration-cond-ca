...
class DiffusionTransformer(nn.Module):
    ...
    def forward(self, x_t, time_t, attention_mask, x_0_self_cond = None, cond=None, cond_mask=None, class_id = None, seq2seq_cond = None, seq2seq_mask = None):
        """
